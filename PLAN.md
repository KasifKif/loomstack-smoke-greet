...
depends_on: [GR-001]
acceptance:
  - research_notes_produced: pytest_patterns
notes: |
  ...
  the literal verifier returns None for non-``file exists:`` patterns and
  trusts the Planner's LLM verdict. Researcher's success → Proposed result
  → Planner says satisfied → criterion passes.
